  ...
  <body role="document">
    ...
    <div class="container">
            <div class="page-header">
                <h1>MongoDB List View</h1>
                <h2>The open items are as follows(MongoDB):</h2>
            </div>
            ...
            <div class="col-md">
                <table class="table table-striped">
                    ...
                    %for row in rows:
                        <tr>
                            <td><a href="/mongodb/edit/{{row[0]}}">{{row[0]}}</a></td>
                            <td><a href="/mongodb/edit/{{row[0]}}">{{row[1]}}</a></td>
                            <td><a href="/mongodb/edit/{{row[0]}}">{{row[2]}}</a></td>
                            <td><a href="/mongodb/delete/{{row[0]}}"><img src="/trash.png" style="width:16px;height:16px;border:0;"/></a></td>
                        </tr>
                    %end
                </table>
            </div>
